...
const getAllProducts = async(req, res)=>{
  const products = await doQuery('SELECT products.id, title, subtitle, price, price_offer, thumbnail_image, detail_images FROM products INNER JOIN products_images ON products_images.product_model_id = products.id')
