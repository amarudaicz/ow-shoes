...
const registerUser = () => {
  ...
  btnSendForm.onclick = async () => {
    ...
    if (data.errors) {
      let errors = data.errors; //Array con los errores del express-validator
      ...
      try {
        ...
        return templateAlert(containerErrors, errors, 'notification-error'); //crea la alerta de usuario ya existente
      }
